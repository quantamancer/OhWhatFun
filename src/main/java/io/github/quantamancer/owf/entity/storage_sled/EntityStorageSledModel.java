...
public class EntityStorageSledModel extends EntityModel<EntityStorageSled> {
    ...
    public EntityStorageSledModel() {
        ...
        modelPartData.addChild("cargo1",ModelPartBuilder.create().uv(0, 0).cuboid(-1.0F, -10.0F, -11.0F, 6.0F, 6.0F, 6.0F), cargoPivot);
        modelPartData.addChild("cargo2",ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -7.0F, -7.0F, 3.0F, 3.0F, 3.0F), cargoPivot);
        modelPartData.addChild("cargo3",ModelPartBuilder.create().uv(0, 0).cuboid(0.0F, -9.0F, -5.0F, 5.0F, 5.0F, 5.0F), cargoPivot);
        modelPartData.addChild("cargo4",ModelPartBuilder.create().uv(0, 0).cuboid(-5.0F, -8.0F, -11.0F, 4.0F, 4.0F, 4.0F), cargoPivot);
